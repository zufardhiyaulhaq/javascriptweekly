...
func (s *JavaScriptWeekly) GetWeekly() []communityv1alpha1.ArticleSpec {
...
func (s *JavaScriptWeekly) GetWeeklyName() string {
	...
	weeklyName = "JavaScript Weekly " + regex.FindString(text)
	return weeklyName
}
